...
bool lane_msgs__msg__lane_marking__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lane_msgs.msg._lane_marking.LaneMarking", full_classname_dest, 39) == 0);
  }
  lane_msgs__msg__LaneMarking * ros_message = _ros_message;
  {  // u
...
PyObject * lane_msgs__msg__lane_marking__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lane_msgs.msg._lane_marking");
