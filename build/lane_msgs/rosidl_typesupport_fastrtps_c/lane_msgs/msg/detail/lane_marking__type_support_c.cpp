...
#include "lane_msgs/msg/detail/lane_marking__rosidl_typesupport_fastrtps_c.h"
...
using _LaneMarking__ros_msg_type = lane_msgs__msg__LaneMarking;
  ...
  void * untyped_ros_message)
{
  ...
  _LaneMarking__ros_msg_type * ros_message = static_cast<_LaneMarking__ros_msg_type *>(untyped_ros_message);
  // Field name: u
  {
    cdr >> ros_message->u;
  }
...
static uint32_t _LaneMarking__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lane_msgs__msg__LaneMarking(
...
static size_t _LaneMarking__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lane_msgs__msg__LaneMarking(
