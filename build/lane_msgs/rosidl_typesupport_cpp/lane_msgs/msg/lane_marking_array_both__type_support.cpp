...
static const _LaneMarkingArrayBoth_type_support_symbol_names_t _LaneMarkingArrayBoth_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lane_msgs, msg, LaneMarkingArrayBoth)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lane_msgs, msg, LaneMarkingArrayBoth)),
  }
};
...
{
  return &::lane_msgs::msg::rosidl_typesupport_cpp::LaneMarkingArrayBoth_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lane_msgs, msg, LaneMarkingArrayBoth)() {
  return get_message_type_support_handle<lane_msgs::msg::LaneMarkingArrayBoth>();
}
