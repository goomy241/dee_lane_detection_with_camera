...
static const _LaneMarkingProjectedArrayBoth_type_support_symbol_names_t _LaneMarkingProjectedArrayBoth_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lane_msgs, msg, LaneMarkingProjectedArrayBoth)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lane_msgs, msg, LaneMarkingProjectedArrayBoth)),
  }
};
...
{
  return &::lane_msgs::msg::rosidl_typesupport_cpp::LaneMarkingProjectedArrayBoth_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lane_msgs, msg, LaneMarkingProjectedArrayBoth)() {
  return get_message_type_support_handle<lane_msgs::msg::LaneMarkingProjectedArrayBoth>();
}
