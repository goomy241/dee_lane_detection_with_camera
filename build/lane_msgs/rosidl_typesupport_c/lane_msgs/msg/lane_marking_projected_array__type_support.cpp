...
static const _LaneMarkingProjectedArray_type_support_symbol_names_t _LaneMarkingProjectedArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lane_msgs, msg, LaneMarkingProjectedArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lane_msgs, msg, LaneMarkingProjectedArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lane_msgs, msg, LaneMarkingProjectedArray)() {
  return &::lane_msgs::msg::rosidl_typesupport_c::LaneMarkingProjectedArray_message_type_support_handle;
}
